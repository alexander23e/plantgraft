        ...
        tblReport = $('#tblReport').DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    class: 'text-left',
                    render: function (data, type, row) {
                        var content = '<ul style="font-size: 13px;" class="py-0">';
                        row.resources.forEach(function (value, index, array) {
                            content += '<li>' + value.resource.name + ' (' + value.cant + ')</li>';
                        });
                        content += '</ul>';
                        return content;
                    }
                },
                {
                    ...
                    render: function (data, type, row) {
                        var content = '<ul style="font-size: 13px;" class="py-0">';
                        row.products.forEach(function (value, index, array) {
                            content += '<li>' + value.product.name + ' (' + value.cant + ')</li>';
                        });
                        content += '</ul>';
                        return content;
                    }
